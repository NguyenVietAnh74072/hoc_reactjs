...
function DanhMuc_SanPham_2() {
    return (
        <React.Fragment>

{/* Product Section Start */}
<div className="section position-relative" style={{marginTop:'50px'}}>
  <div className="container">
    {/* Section Title & Tab Start */}
    <div className="row mb-lg-8 mb-6">
      {/* Section Title Start */}
      <div className="col-lg col-12">
        <div className="section-title mb-0 text-center" data-aos="fade-up" data-aos-delay={400}>
                  ...
                  <div className="product">
                    <div className="thumb">
                      <a href="single-product.html" className="image">
                        ...
                        <img className="second-image fit-image" src="assets/images/products/medium-product/4.jpg" alt="Product" />
                      </a>
                      <span className="badges">
              ...
              <div className="swiper-slide">
                <div className="product-wrapper">
                  <div className="product mb-6">
                    <div className="thumb">
                      <a href="single-product.html" className="image">
                        <img className="fit-image" src="assets/images/products/medium-product/5.jpg" alt="Product" />
                        <img className="second-image fit-image" src="assets/images/products/medium-product/7.jpg" alt="Product" />
                      </a>
                      <span className="badges">
                    ...
                    <div className="content">
                      <h5 className="title"><a href="single-product.html">Happy Kids With Gift</a></h5>
                      <span className="price">
                  ...
                  <div className="product">
                    <div className="thumb">
                      <a href="single-product.html" className="image">
                        ...
                        <img className="second-image fit-image" src="assets/images/products/medium-product/6.jpg" alt="Product" />
                      </a>
                      <span className="badges">
                        <span className="sale">-20%</span>
                      </span>
              ...
              <div className="swiper-slide">
                <div className="product-wrapper">
                  <div className="product mb-6">
                    <div className="thumb">
                      <a href="single-product.html" className="image">
                        <img className="fit-image" src="assets/images/products/medium-product/8.jpg" alt="Product" />
                        <img className="second-image fit-image" src="assets/images/products/medium-product/10.jpg" alt="Product" />
                      </a>
                      <span className="badges">
                        <span className="new">New</span>
                      </span>
                  ...
                  <div className="product">
                    <div className="thumb">
                      <a href="single-product.html" className="image">
                        <img className="fit-image" src="assets/images/products/medium-product/9.jpg" alt="Product" />
                        <img className="second-image fit-image" src="assets/images/products/medium-product/11.jpg" alt="Product" />
                      </a>
                      <div className="actions">
                        <a href="wishlist.html" className="action wishlist"><i className="pe-7s-like" /></a>
                        <a href="compare.html" className="action compare"><i className="pe-7s-refresh-2" /></a>
              ...
              <div className="swiper-slide">
                <div className="product-wrapper">
                  <div className="product mb-6">
                    <div className="thumb">
                      <a href="single-product.html" className="image">
                        <img className="fit-image" src="assets/images/products/medium-product/12.jpg" alt="Product" />
                        <img className="second-image fit-image" src="assets/images/products/medium-product/1.jpg" alt="Product" />
                      </a>
                      <div className="actions">
                        <a href="wishlist.html" className="action wishlist"><i className="pe-7s-like" /></a>
                        <a href="compare.html" className="action compare"><i className="pe-7s-refresh-2" /></a>
                    ...
                    <div className="content">
                      <h5 className="title"><a href="single-product.html">Baby Rocking Horse</a></h5>
                      <span className="price">
                        <span className="new">
                          $25.50
                        </span>
                  ...
                  <div className="product">
                    <div className="thumb">
                      <a href="single-product.html" className="image">
                        <img className="fit-image" src="assets/images/products/medium-product/7.jpg" alt="Product" />
                        <img className="second-image fit-image" src="assets/images/products/medium-product/5.jpg" alt="Product" />
                      </a>
                      <span className="badges">
                        <span className="sale">-18%</span>
                      </span>
...
export default DanhMuc_SanPham_2
